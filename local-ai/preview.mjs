...
const files = ['js/assistant-session.js', 'test/fixtures/smart-alarm-preview.html', 'test/fixtures/smart-alarm-preview.js', 'test/fixtures/smart-alarm-preview-start.js', 'css/alarm-center.css', 'css/smart-alarm.css', 'js/alarm-core.js', 'js/alarm-intent.js', 'js/smart-alarm-ui.js', 'js/alarm-center.js'];
