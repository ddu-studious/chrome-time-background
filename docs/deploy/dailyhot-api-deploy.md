...
访问 [https://github.com/imsyy/DailyHotApi](https://github.com/imsyy/DailyHotApi) ，点击右上角 **Fork** 按钮，Fork 到自己的 GitHub 账号下。
...
1. 访问 [https://railway.app](https://railway.app) ，使用 GitHub 登录
